...
from datasets.crowd import Crowd_qnrf, Crowd_nwpu, Crowd_sh, CustomDataset, Crowd_visdrone
...
class Trainer(object):
    ...
    def setup(self):
        args = self.args
        sub_dir = (
            "{}/{}_12-1-input-{}_wot-{}_wtv-{}_reg-{}_nIter-{}_normCood-{}".format(
                args.arch,
                args.run_name,
                args.crop_size,
                args.wot,
        ...
        elif args.dataset.lower() == "visdrone": # <-- MODIFY THIS BLOCK
            # The root_path IS the VisDrone2020-CC folder now
            # The Crowd_visdrone class handles finding train/val via list files
            visdrone_root_path = args.data_dir # e.g., C:/.../VisDrone2020-CC
            self.datasets = {
                "train": Crowd_visdrone(
                    visdrone_root_path, args.crop_size, downsample_ratio, "train"
                ),
                "val": Crowd_visdrone( # Using testlist.txt for validation
                    visdrone_root_path, args.crop_size, downsample_ratio, "val"
                ),
            }
        ...
        self.model = FFNet.__dict__[args.arch]() 
        ...
        if args.wandb:
            ...
            config=args, project="FFNet", name=args.run_name
        )
        else : 
    ...
    def val_epoch(self):
        ...
        if mae < self.best_mae:
            ...
            model_path = os.path.join(
                self.save_dir, "best_model_mae.pth"
            )
            torch.save(
                model_state_dic,
                model_path,
