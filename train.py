...
import numpy as np
import os
from datasets.crowd import Crowd_qnrf, Crowd_nwpu, Crowd_sh, CustomDataset, Crowd_visdrone # <-- Add Crowd_visdrone
...
def parse_args():
    ...
    if args.dataset.lower() == 'qnrf':
        ...
        args.crop_size = 384
        args.val_epoch = 5 # Maybe adjust val_epoch for VisDrone too?
    elif args.dataset.lower() == 'sha':
        args.crop_size = 256
    elif args.dataset.lower() == 'shb':
        args.crop_size = 512
    elif args.dataset.lower() == 'visdrone': # <-- ADD THIS BLOCK
        args.crop_size = 768 # VisDrone images often larger, start with 768? Adjust if needed.
        args.val_epoch = 5  # Validate less frequently for larger dataset
